...
const Feed = () => {
  ...
  const data = [
    ...
    },
    {
      ...
      description: "We are looking for a software engineer with experience in developing scalable web applications. The candidate should have a strong background in JavaScript and familiarity with React and Node.js.",
      education: "Masters",
      jobType: "Fulltime"
    },
    {
      ...
      description: "Join our team of creative professionals to design stunning visuals for our clients. Proficiency in Adobe Creative Suite is required. Previous experience in a design agency is preferred.",
      education: "Bachelors",
      jobType: "Fulltime"
    },
    {
      ...
      description: "We are seeking a data analyst intern to join our team. The ideal candidate will have a strong analytical mindset and be proficient in Excel and SQL. This is a great opportunity to gain hands-on experience in data analysis.",
      education: "Bachelors",
      jobType: "Internship"
    },
    {
      ...
      description: "We are hiring a marketing specialist to develop and execute marketing strategies for our products. The candidate should have experience in digital marketing and be familiar with SEO, SEM, and social media marketing.",
      education: "Bachelors",
      jobType: "Fulltime"
    }
  ];
  ...
  return (
    ...
    <div className='px-12 grid grid-cols-2 gap-2 h-[100vh]'>
      <div className='overflow-y-scroll'>
      {
        data?.map((doc, index) => {
          ...
          {currentData !== empttObj?   <div className='border border-black rounded-lg px-4 space-y-1 py-2 h-full  overflow-y-scroll '>
       <h1 className='font-sans text-2xl '>{currentData?.title}</h1>
      
        <h2 className='text-xl underline underline-offset-2'>{currentData?.companyName}</h2>
